...
// TODO: this is basically identical to IlReferenceEquality except for, like, two relaxations,
// decide if its existence is justified
internal static class IlReferenceMatching {
	...
	private static bool typeEquals(IlTypeRef? left, IlTypeRef? right) {
		...
		return (left, right) switch {
			...
			(IlNamedTypeRef a, IlNamedTypeRef b) =>
				IlReferenceEquality.ScopeEquals(a.Scope, b.Scope) && typeEquals(a.DeclaringType, b.DeclaringType) &&
			...
			(IlGlobalModuleTypeRef a, IlGlobalModuleTypeRef b) => IlReferenceEquality.ScopeEquals(a.Scope, b.Scope),
