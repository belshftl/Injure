...
#pragma warning disable RS2008 // enable analyzer release tracking
	public static readonly DiagnosticDescriptor MissingOpenClassMarker = new(
		...
		messageFormat: "This should probably be a `sealed class`. Think long and hard before making a class inheritable; if you're really absolutely sure that deriving it is a fully supported public API, mark it with `/* open */` where `sealed` normally goes, and add a doc comment about derived-class behavior/notes/intentions.",
		category: "Core",
