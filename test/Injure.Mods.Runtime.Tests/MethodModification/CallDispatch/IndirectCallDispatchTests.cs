...
using Injure.Mods.Runtime.MethodModification.CallDispatch;

namespace Injure.Mods.Runtime.Tests.MethodModification.CallDispatch;
...
#pragma warning restore SYSLIB1054 // mark with LibraryImportAttribute instead of DllImportAttribute
	...
	public static void IndirectCallEmitsExpectedInstructions() {
		...
		Assert.Equal(IlReferenceFactory.Method(m).Signature, operand.Signature);
	}
