...
namespace Injure.Mods.Runtime.Tests.MethodModification.Profiler;
...
public sealed class ProfilerTokenResolverTests : IDisposable {
	...
	public void AConstructedTypeBecomesATypeSpecification() {
		IlTypeRef array = IlReferenceFactory.SzArray(new IlPrimitiveTypeRef(PrimitiveTypeCode.Int32));
	...
	public void IdenticalConstructedTypesShareOneSpecification() {
		IlTypeRef first = IlReferenceFactory.SzArray(new IlPrimitiveTypeRef(PrimitiveTypeCode.Int64));
		IlTypeRef second = IlReferenceFactory.SzArray(new IlPrimitiveTypeRef(PrimitiveTypeCode.Int64));
	...
	public void AGenericInstantiationBecomesAMethodSpecificationOverAMemberReference() {
		...
		IlMethodRef instantiated = IlReferenceFactory.GenericMethod(
			definition,
	...
	public void AMemberOnAGenericInstanceIsParentedToATypeSpecification() {
		...
		IlGenericInstanceTypeRef instance = IlReferenceFactory.GenericInstance(
			definition,
			new IlPrimitiveTypeRef(PrimitiveTypeCode.Int32)
		);
		IlMethodRef method = IlReferenceFactory.Method(
			instance,
			"Get",
			IlReferenceFactory.Signature(IlReferenceFactory.TypeGenericParameter(0))
		);
	...
	private static IlMethodRef newMethod(string @namespace, string typeName, string methodName) =>
		IlReferenceFactory.Method(
			...
			methodName,
			IlReferenceFactory.Signature(new IlPrimitiveTypeRef(PrimitiveTypeCode.Void))
		);
