...
public sealed class MethodModificationRegistryTests {
	...
	private static MethodModificationRegistry makeRegistry(params string[] loadOrder) =>
	...
	private static readonly MethodBase impl =
		typeof(MethodModificationRegistryTests).GetMethod(nameof(stub), BindingFlags.NonPublic | BindingFlags.Static)!;
	...
	public static void UnregisteredMethodHasNoGeneration() {
		MethodModificationRegistry registry = makeRegistry();
	...
	public static void ManipulatorsAreOrderedByOwner() {
		MethodModificationRegistry registry = makeRegistry("first", "second", "third");
	...
	public static void OrderingHoldsAcrossOwnersAndRegistrationOrderTogether() {
		MethodModificationRegistry registry = makeRegistry("first", "second");
...
public sealed class MethodTransformCacheTests {
	...
	private static IlMethodBody makeBody() =>
		IlMethodBody.CreateEmpty(IlReferenceFactory.Method(typeof(object).GetMethod(
