...
public sealed class IlMethodSignature : IEquatable<IlMethodSignature> {
	...
	/// </summary>
	public bool Equals(IlMethodSignature? other) => IlRefEquality.SignatureEquals(this, other);
	...
	/// </summary>
	public override int GetHashCode() => IlRefEquality.SignatureHashCode(this);
