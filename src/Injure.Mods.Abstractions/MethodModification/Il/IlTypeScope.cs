...
public abstract class IlTypeScope {
	...
	public bool Equals(IlTypeScope? other) => IlReferenceEquality.ScopeEquals(this, other);
	public sealed override bool Equals([NotNullWhen(true)] object? obj) => obj is IlTypeScope other && Equals(other);
	public sealed override int GetHashCode() => IlReferenceEquality.ScopeHashCode(this);
