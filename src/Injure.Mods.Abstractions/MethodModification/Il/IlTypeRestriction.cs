...
internal static class IlTypeRestrictionCheck {
	...
	public static IlTypeRestriction? CheckMethodOperand(IlMethodRef method, in IlOwnerContext ctx) {
	...
	public static IlTypeRestriction? CheckFieldOperand(IlFieldRef field, in IlOwnerContext ctx) {
	...
	public static IlTypeRestriction? CheckSignature(IlMethodSignature signature, in IlOwnerContext ctx) {
	...
	public static IlTypeRestriction? CheckLocals(ImmutableArray<IlTypeRef> locals, in IlOwnerContext ctx) {
	...
	public static IlTypeRestriction? CheckSignatureType(IlTypeRef type, in IlOwnerContext ctx) {
	...
	public static IlTypeRestriction? CheckTypeOperand(IlTypeRef type, in IlOwnerContext ctx) {
		InternalStateException.ThrowIfNull(type);
		switch (type) {
		case IlNamedTypeRef named:
	...
	private static bool isReloadable(IlTypeRef type, in IlOwnerContext ctx) {
		for (;;) {
			switch (type) {
			case IlNamedTypeRef named:
