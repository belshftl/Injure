...
public sealed class BijectiveMap<TLeft, TRight> : IBijectiveMap<TLeft, TRight> where TLeft : notnull where TRight : notnull {
	// ==========================================================================
	// bookkeeping
	...
	public BijectiveMap(IEnumerable<(TLeft Left, TRight Right)> pairs, IEqualityComparer<TLeft>? cmpLeft = null, IEqualityComparer<TRight>? cmpRight = null) {
		(ltr, rtl) = make(pairs, cmpLeft, cmpRight);
	}

	public BijectiveMap(TLeft[] lefts, TRight[] rights, IEqualityComparer<TLeft>? cmpLeft = null, IEqualityComparer<TRight>? cmpRight = null) {
