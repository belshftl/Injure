...
/// </para>
/// <para>
/// The ring has a fixed <see cref="Capacity"/>. Methods such as <see cref="PushNewest(T)"/>
/// and <see cref="PushOldest(T)"/> overwrite an existing element when the ring is full.
...
/// Enumeration through the concrete <see cref="Ring{T}"/> or <see cref="ReverseEnumerable"/> types
...
public sealed class Ring<T> : IReadOnlyList<T> {
	...
	/// <summary>
	/// Initializes a new ring with the specified fixed capacity.
	/// </summary>
	/// <param name="capacity">The maximum number of elements the ring can hold.</param>
	...
	/// <summary>
	/// Initializes a new ring with the specified fixed capacity and appends the provided items.
	/// </summary>
	/// <param name="capacity">The maximum number of elements the ring can hold.</param>
	...
	/// </exception>
	public Ring(int capacity, IEnumerable<T> items) : this(capacity) {
	...
	/// <summary>
	/// The maximum number of elements the ring can hold.
	/// </summary>
	public int Capacity => buf.Length;

	/// <summary>
	/// How many more elements the ring can hold.
	/// </summary>
	public int RemainingCapacity => buf.Length - count;

	/// <summary>
	/// The number of elements currently stored in the ring.
	/// </summary>
	public int Count => count;

	/// <summary>
	/// Whether the ring currently contains no elements.
	/// </summary>
	public bool IsEmpty => count == 0;

	/// <summary>
	/// Whether the ring is currently at full capacity.
	/// </summary>
	...
	/// </param>
	/// <exception cref="ArgumentOutOfRangeException">
	/// Thrown if <paramref name="idx"/> is outside the bounds of the ring.
	/// </exception>
	...
	/// <summary>
	/// Returns the oldest element in the ring without removing it.
	/// </summary>
	/// <exception cref="InvalidOperationException">
	/// Thrown if the ring is empty.
	/// </exception>
	public T PeekOldest() {
		throwIfEmpty();
		return buf[head];
	...
	/// <summary>
	/// Returns the newest element in the ring without removing it.
	/// </summary>
	/// <exception cref="InvalidOperationException">
	/// Thrown if the ring is empty.
	/// </exception>
	...
	/// <summary>
	/// Attempts to return the oldest element in the ring without removing it.
	/// </summary>
	/// <param name="item">
	/// If the method returned <see langword="true"/>, the oldest element; otherwise,
	/// the default value of <typeparamref name="T"/>.
	/// </param>
	/// <returns><see langword="true"/> if the ring is non-empty; otherwise, <see langword="false"/>.</returns>
	...
	/// <summary>
	/// Attempts to return the newest element in the ring without removing it.
	/// </summary>
	/// <param name="item">
	...
	/// <summary>
	/// Appends an element at the logical end of the ring.
	/// </summary>
	/// <param name="item">The element to append.</param>
	/// <remarks>
	/// If the ring is full, the oldest element is overwritten.
	/// </remarks>
	...
	/// <summary>
	/// Prepends an element at the logical beginning of the ring.
	/// </summary>
	/// <param name="item">The element to prepend.</param>
	/// <remarks>
	/// If the ring is full, the newest element is overwritten.
	/// </remarks>
	...
	/// <summary>
	/// Attempts to append an element at the logical end of the ring without overwriting/removing
	/// any existing elements.
	/// </summary>
	/// <param name="item">The element to append.</param>
	/// <returns>
	/// <see langword="true"/> if the element was appended; <see langword="false"/> if the ring was full.
	/// </returns>
	...
	/// <summary>
	/// Attempts to prepend an element at the logical beginning of the ring without overwriting/removing
	/// any existing elements.
	/// </summary>
	/// <param name="item">The element to prepend.</param>
	/// <returns>
	/// <see langword="true"/> if the element was prepended; <see langword="false"/> if the ring was full.
	/// </returns>
	...
	/// <summary>
	/// Removes and returns the oldest element in the ring.
	/// </summary>
	/// <exception cref="InvalidOperationException">
	/// Thrown if the ring is empty.
	/// </exception>
	...
	/// <summary>
	/// Removes and returns the newest element in the ring.
	/// </summary>
	/// <exception cref="InvalidOperationException">
	/// Thrown if the ring is empty.
	/// </exception>
	...
	/// <summary>
	/// Attempts to remove and return the oldest element in the ring.
	/// </summary>
	/// <param name="item">
	...
	/// <summary>
	/// Attempts to remove and return the newest element in the ring.
	/// </summary>
	/// <param name="item">
	/// If the method returned <see langword="true"/>, the removed element; otherwise,
	/// the default value of <typeparamref name="T"/>.
	...
	/// </summary>
	/// <remarks>
	/// The capacity of the ring is unchanged.
	/// </remarks>
	public void Clear() {
	...
	/// <summary>
	/// Determines whether the ring contains the specified element, using
	...
	/// <summary>
	/// Copies the contents of the ring into the specified span.
	/// </summary>
	/// <param name="dst">The destination span.</param>
	/// <remarks>
	/// Elements are copied in the ring's enumeration order (oldest to newest).
	/// </remarks>
	...
	/// <summary>
	/// Returns a new array containing the contents of the ring.
	/// </summary>
	/// <remarks>
	/// Elements are in the ring's enumeration order (oldest to newest).
	/// </remarks>
	public T[] ToArray() {
		if (count == 0)
	...
	/// </summary>
	/// <param name="range">
	/// The slice of the ring to capture.
	/// </param>
	public RingView<T> View(Range range) {
	...
	/// Length of the slice.
	/// </param>
	public RingView<T> View(int start, int length) {
		validateSlice(start, length);
		ulong capturedVersion = version;
		int physicalStart = physicalIndex(start);
		int firstLength = Math.Min(length, buf.Length - physicalStart);
		return new RingView<T>(this, capturedVersion, buf.AsSpan(physicalStart, firstLength), buf.AsSpan(0, length - firstLength));
	}

	/// <summary>
	/// Returns an enumerator that iterates through the ring from oldest to newest.
	/// </summary>
	...
	/// <summary>
	/// Returns an enumerable that enumerates the contents of the ring from newest to oldest.
	/// </summary>
	...
	/// <summary>
	/// Enumerates a <see cref="Ring{T}"/> from oldest to newest.
	/// </summary>
	/// <remarks>
	/// <para>
	...
	/// </para>
	/// <para>
	/// Any successful mutation of the underlying <see cref="Ring{T}"/> causes invalidation.
	/// </para>
	/// <para>
	...
	public struct Enumerator : IEnumerator<T> {
		private readonly Ring<T> ringbuf;
		private readonly ulong version;
		private int idx;
		private int physicalIdx;

		internal Enumerator(Ring<T> ringbuf) {
	...
	/// <summary>
	/// Enumerable for <see langword="foreach"/> enumeration of a <see cref="Ring{T}"/>
	/// in reverse (newest to oldest) order.
	/// </summary>
	public readonly struct ReverseEnumerable : IEnumerable<T> {
		private readonly Ring<T> ringbuf;

		internal ReverseEnumerable(Ring<T> ringbuf) {
			this.ringbuf = ringbuf;
		}
	...
	/// <summary>
	/// Enumerates a <see cref="Ring{T}"/> from newest to oldest.
	/// </summary>
	/// <remarks>
	/// <para>
	/// No managed heap allocations are performed when this struct is not boxed to an interface.
	...
	public struct ReverseEnumerator : IEnumerator<T> {
		...
		internal ReverseEnumerator(Ring<T> ringbuf) {
			this.ringbuf = ringbuf;
			version = ringbuf.version;
			idx = ringbuf.count;
	...
	// ==========================================================================
	// debug view
	private sealed class RingDebuggerTypeProxy<TItem>(Ring<TItem> ringbuf) {
...
/// <summary>
/// A read-only, non-owning view of a captured logical range of a <see cref="Ring{T}"/>.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// Any subsequent successful mutation of the originating ring invalidates the view. Accessing
...
/// </para>
/// </remarks>
public readonly ref struct RingView<T> {
	private readonly Ring<T> owner;
	private readonly ulong version;
	private readonly ReadOnlySpan<T> first;
	private readonly ReadOnlySpan<T> second;
	private readonly int count;

	internal RingView(Ring<T> owner, ulong version, ReadOnlySpan<T> first, ReadOnlySpan<T> second) {
		this.owner = owner;
	...
	private void throwIfInvalid() {
		if (owner is not null && owner.Version != version)
			throw new InvalidOperationException("originating ring was modified");
	}
	...
	/// </summary>
	/// <exception cref="InvalidOperationException">
	/// Thrown if the originating ring has been modified since the view was created.
	/// </exception>
	public int Count {
		get {
			throwIfInvalid();
	...
	/// </param>
	/// <remarks>
	/// The returned view refers to the same originating ring and is invalidated by the
	...
	/// Thrown if the originating ring has been modified since the view was created.
	/// </exception>
	public RingView<T> this[Range range] {
		get {
			throwIfInvalid();
			(int start, int length) = range.GetOffsetAndLength(count);
	...
	/// <summary>
	/// Enumerates a <see cref="RingView{T}"/> from oldest to newest.
	/// </summary>
	/// <remarks>
	/// <para>
	...
	/// </para>
	/// <para>
	/// Any successful mutation of the originating <see cref="Ring{T}"/> causes invalidation.
	/// </para>
	/// </remarks>
	public ref struct Enumerator {
		private readonly RingView<T> view;
		private int index;

		internal Enumerator(RingView<T> view) {
			this.view = view;
			index = -1;
		}
	...
	/// <summary>
	/// Enumerable for <see langword="foreach"/> enumeration of a <see cref="RingView{T}"/>
	/// in reverse (newest to oldest) order.
	/// </summary>
	public readonly ref struct ReverseEnumerable {
		private readonly RingView<T> view;
		internal ReverseEnumerable(RingView<T> view) {
			this.view = view;
		}
	...
	/// <summary>
	/// Enumerates a <see cref="RingView{T}"/> from newest to oldest.
	/// </summary>
	/// <remarks>
	/// <para>
	/// No managed heap allocations are performed. All individual operations are O(1),
	...
	public ref struct ReverseEnumerator {
		...
		internal ReverseEnumerator(RingView<T> view) {
			this.view = view;
			index = view.count;
		}
